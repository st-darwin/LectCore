...
const StudentDashboard = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-28 sm:py-36 bg-white/80 backdrop-blur-xl rounded-3xl sm:rounded-[2.5rem] border border-slate-100 shadow-2xs mx-2 sm:mx-0">
        <div className="flex flex-col items-center gap-3">
          <Loader2 className="w-8 h-8 text-indigo-500 animate-spin" />
          <p className="text-xs font-medium text-slate-400 tracking-wide">Loading your dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6 pb-20 sm:pb-16 animate-in fade-in duration-300 px-3 sm:px-4 lg:px-0 text-slate-600 overflow-x-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-5 sm:gap-6">
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-500 max-w-lg leading-relaxed">
              Your academic command center is fully synchronized. Check your course updates and explore enrolled materials.
            </p>
          </div>
      ...
      {/* Stats Grid - Optimized for Mobile Grid */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white/90 backdrop-blur-xl border border-slate-100/90 shadow-2xs space-y-2.5 sm:space-y-3 hover:border-indigo-200/80 transition-all">
          ...
          <div>
            <p className="text-[10px] sm:text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Student Status</p>
            <p className="text-xl sm:text-2xl font-bold text-slate-800 mt-0.5">Verified</p>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white/90 backdrop-blur-xl border border-slate-100/90 shadow-2xs space-y-2.5 sm:space-y-3 hover:border-indigo-200/80 transition-all">
          ...
          <div>
            <p className="text-[10px] sm:text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Access Level</p>
            <p className="text-xl sm:text-2xl font-bold text-slate-800 mt-0.5">Standard</p>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-white/90 backdrop-blur-xl border border-slate-100/90 shadow-2xs space-y-2.5 sm:space-y-3 hover:border-indigo-200/80 transition-all">
          ...
          <div>
            <p className="text-[10px] sm:text-[11px] font-semibold text-slate-400 uppercase tracking-wider">System State</p>
            <p className="text-xl sm:text-2xl font-bold text-slate-800 mt-0.5">Online</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] bg-white/90 backdrop-blur-xl border border-slate-100/90 shadow-2xs space-y-5 sm:space-y-6">
